...
using Silverbrain.OnlineShop.Common.IdentityToolkit;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace Silverbrain.OnlineShop.Entities.AuditableEntity
{
    public static class AuditableShadowProperties
    {
        ...
        //است IAuditableEntity به جداولی که از نوع  ShadowProperty افزودن فیلد های  
