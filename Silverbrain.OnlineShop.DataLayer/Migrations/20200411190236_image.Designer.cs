...
namespace Silverbrain.OnlineShop.DataLayer.Migrations
{
    ...
    [Migration("20200411190236_image")]
    partial class image
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Silverbrain.OnlineShop.Entities.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Silverbrain.OnlineShop.Entities.Models.Slider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Silverbrain.OnlineShop.Entities.Models.BrandImage", b =>
                {
                    b.HasOne("Silverbrain.OnlineShop.Entities.Models.Brand", "Brand")
                        .WithOne("Image")
                        .HasForeignKey("Silverbrain.OnlineShop.Entities.Models.BrandImage", "Brand_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
