!function(e) {
    ...
    !function(e, t) {
        ...
        kendo.ui.ColumnMenu && (kendo.ui.ColumnMenu.prototype.options.messages = e.extend(!0, kendo.ui.ColumnMenu.prototype.options.messages, {
            sortAscending: "به ترتیب صعودی",
            sortDescending: "به ترتیب نزولی",
            filter: "فیلتر",
            column: "ستون",
            columns: "ستون ها",
        ...
        kendo.ui.Editor && (kendo.ui.Editor.prototype.options.messages = e.extend(!0, kendo.ui.Editor.prototype.options.messages, {
            ...
            orderBySize: "Size",
            orderByName: "Name",
            invalidFileType: 'فابل انتخاب شده "{0}" موردتایید نیست. فایل های مورد تایید {1} هستند.',
            deleteFile: 'آیا از پاک کردن فایل "{0}" اطمینان دارید؟',
            overwriteFile: 'یک فایل با نام "{0}" در این پوشه وجود دارد. آیا می خواهید روی آن بازنویسی کنید؟',
        ...
        kendo.ui.FileBrowser && (kendo.ui.FileBrowser.prototype.options.messages = e.extend(!0, kendo.ui.FileBrowser.prototype.options.messages, {
            ...
            invalidFileType: 'فابل انتخاب شده "{0}" موردتایید نیست. فایل های مورد تایید {1} هستند.',
            overwriteFile: 'یک فایل با نام "{0}" در این پوشه وجود دارد. آیا می خواهید روی آن بازنویسی کنید؟',
            dropFilesHere: "فایل را اینجا رها کنید تا بارگزاری شود.",
            search: "جست و جو"
        })),
        ...
        kendo.ui.FilterCell && (kendo.ui.FilterCell.prototype.options.operators = e.extend(!0, kendo.ui.FilterCell.prototype.options.operators, {
            string: {
                ...
                isnullorempty: "مقدار ندارد",
                isnotnullorempty: "مقدار دارد"
            },
            number: {
                eq: "برابر است با",
                neq: "برابر نیست با",
                gte: "بزرگتر یا برابر است با",
                gt: "بزرگتر است از",
                lte: "کوچکتر یا برابر است با",
                lt: "کوچکتر است از",
                isnull: "پوچ است",
                isnotnull: "پوچ نیست"
            },
        ...
        kendo.ui.FilterMenu && (kendo.ui.FilterMenu.prototype.options.messages = e.extend(!0, kendo.ui.FilterMenu.prototype.options.messages, {
            info: "موارد با مقداری را نشان بده که:",
            title: "موارد با مقداری را نشان بده که:",
            isTrue: "درست است",
            isFalse: "اشتباه است",
            filter: "فیلتر",
            clear: "پاک کردن",
        ...
        kendo.ui.Grid && (kendo.ui.Grid.prototype.options.messages = e.extend(!0, kendo.ui.Grid.prototype.options.messages, {
            ...
            editable: {
                cancelDelete: "انصراف",
                confirmation: "آیا از پاک کردن این رکورد اطمینان دارید؟",
                confirmDelete: "حذف"
            },
            noRecords: "هیچ موردی وجود ندارد.",
            search: "جست و جو...",
            expandCollapseColumnHeader: "",
            groupHeader: "برای گروه بندی، کنترل + فاصله را فشار دهید.",
            ungroupHeader: "برای حذف گروه بندی، کنترل + فاصله را فشار دهید."
        })),
        kendo.ui.TreeList && (kendo.ui.TreeList.prototype.options.messages = e.extend(!0, kendo.ui.TreeList.prototype.options.messages, {
            noRows: "موردی برای نمایش نیست.",
            loading: "بارگزاری",
            requestFailed: "درخواست با خطا مواجه شد.",
            retry: "سعی دوباره",
            commands: {
                edit: "تغییر",
                update: "به روزرسانی",
        ...
        kendo.ui.Groupable && (kendo.ui.Groupable.prototype.options.messages = e.extend(!0, kendo.ui.Groupable.prototype.options.messages, {
            empty: "یک سر ستون را کشیده و اینجا رها کنید تا بر اساس آن گروه بندی شود"
        })),
        ...
        kendo.spreadsheet && kendo.spreadsheet.messages.toolbar && (kendo.spreadsheet.messages.toolbar = e.extend(!0, kendo.spreadsheet.messages.toolbar, {
            ...
            saveAs: "Save As...",
            sortAsc: "به ترتیب صعودی",
            sortDesc: "به ترتیب نزولی",
            sortButtons: {
